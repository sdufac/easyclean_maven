...
// postulation(idMission,idCleaner,horaireStart,horaireEnd,salaireCleaner)
// VALUES("
// + m.getIdMission() + "," + user.getId() + "," + debutHoraire + "," +
// finHoraire + "," + this.salary
// + ");";
//
// String strPostulation = "SELECT * FROM postulation JOIN mission ON idMission
// = mission_id JOIN statut_mission ON statut=statut_id JOIN propriete ON
// id_propriete = propriete_id WHERE idCleaner ="
...
// String adress = rsPostulation.getString("adress") + " " +
// rsPostulation.getString("ville") + " "
// + rsPostulation.getString("code_postal");
// Mission m = new Mission(rsPostulation.getString("date_mission"),
// rsPostulation.getDouble("time_mission"),
// rsPostulation.getString("instruction"),
// rsPostulation.getDouble("proprietaire_start"),
// rsPostulation.getDouble("proprietaire_end"),
// adress, rsPostulation.getInt("id_proprietaire"), user.getId(),
